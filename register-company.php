            ...
            <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
              ...
              <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <input class="form-control input-sm" type="text" name="companyname" placeholder="Company Name"
                      required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <textarea class="form-control input-sm" rows="4" name="aboutme"
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <input class="form-control input-sm" type="password" name="cpassword" placeholder="Confirm Password"
                      required>
                  </div>
                  ...
                  <div class="form-group">
                    <input class="form-control input-sm" type="text" name="contactno" placeholder="Phone Number"
                      minlength="10" maxlength="10" autocomplete="off" onkeypress="return validatePhone(event);"
                      required>
                  </div>
                  <div class="form-group">
