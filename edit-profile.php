  ...
  <div id="wrapper">
    <div id="sidebar-nav" class="sidebar">
      <div class="sidebar-scroll">
        <nav>
          <ul class="nav">
            <li><a href="dashboard_candidate.php" class="active"><i class="lnr lnr-home"></i> <span>Dashboard</span></a>
            </li>
            ...
            <li><a href="applied-jobs.php" class=""><i class="lnr lnr-calendar-full"></i></span>Applied Jobs</span></a>
            </li>
            ...
            <div class="row">
              <div class="col-md-6 latest-job ">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control input-sm" id="fname" name="fname" placeholder="First Name"
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control input-sm" id="city" name="city" value="<?php echo $row['city']; ?>"
                    placeholder="city">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6 latest-job ">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control input-sm" id="contactno" name="contactno"
