			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="edit-company.php" class=""><i class="lnr lnr-pencil"></i>Edit Profile</span></a>
						</li>
						<li><a href="create-job-post.php" class=""><i class="lnr lnr-calendar-full"></i></span>Create
								Job</span></a></li>
						<li><a href="my-job-post.php" class=""><i class="lnr lnr-briefcase"></i> <span>My Job
									Posts</span></a></li>
						<li><a href="job-applications.php" class=""><i class="lnr lnr-envelope"></i> <span>Job
									...
									if ($result->num_rows > 0) {
										while ($row = $result->fetch_assoc()) {
											...
											<tr>
												...
												<td><a href="company-view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><i
															class="lnr lnr-briefcase"></i></a></td>
											</tr>
											<?php
										}
									}
