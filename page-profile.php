	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="dashboard_candidate.php" class="active"><i class="lnr lnr-home"></i>
								<span>Dashboard</span></a></li>
						<li><a href="page-profile.php" class=""><i class="lnr lnr-user"></i> <span>Profile</span></a>
						</li>
						<li><a href="edit-profile.php" class=""><i class="lnr lnr-pencil"></i>Edit Profile</span></a>
						</li>
						<li><a href="applied-jobs.php" class=""><i class="lnr lnr-calendar-full"></i></span>Applied
								Jobs</span></a></li>
						<li><a href="jobs.php" class=""><i class="lnr lnr-briefcase"></i> <span>Available
									Jobs</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
								...
								<div class="profile-right">
									<div class="profile-info">
										<ul class="list-unstyled list-justify">
											<li>
												<h4 class="heading">About<span><button type="submit"
															class="btn btn-primary btn-sm btn-block">Edit</button> </span></h4>
											</li>
									...
									<div class="profile-detail">
										<div class="profile-info">
											...
											<ul class="list-unstyled list-justify">
												...
												<li>Address<span><?php echo $row['address']; ?><?php echo $row['state']; ?></span>
												</li>
				...
				<footer>
					<div class="container-fluid">
						<p class="copyright">&copy; 2018 <a href="https://www.themeineed.com" target="_blank">Theme I Need</a>.
